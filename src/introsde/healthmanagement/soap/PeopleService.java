 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.healthmanagement.introsde/", wsdlLocation = "http://localhost:6911/soap/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://soap.healthmanagement.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:6911/soap/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://soap.healthmanagement.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.healthmanagement.introsde/", "PeopleImplPort"), People.class, features);
    }
